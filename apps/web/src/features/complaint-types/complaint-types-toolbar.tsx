...
import type { SortState } from "@/features/complaint-types/complaint-types-list";

interface ComplaintTypesToolbarProps {
  search: string;
...
export function ComplaintTypesToolbar({
  search,
  onSearchSubmit,
  sort,
  onSortChange,
}: ComplaintTypesToolbarProps) {
  const currentLabel =
