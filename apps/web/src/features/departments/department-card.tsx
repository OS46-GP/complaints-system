...
export function DepartmentCard({ department, onEdit }: DepartmentCardProps) {
  return (
    <div className="group h-full bg-surface-container-lowest border border-border rounded-xl p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5">
